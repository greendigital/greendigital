...
<div class="<?php echo $class; ?>"><?php mk_sidebar_generator( 'get_footer_sidebar' )  ?>
</div>
...
?>
		...
		<div class="mk-col-1-2">
			...
			<div class="mk-col-1-3"><?php mk_sidebar_generator( 'get_footer_sidebar' ); ?>
			</div>
...
<?php
	...
	<a href="#" class="mk-go-top"><i class="mk-moon-arrow-up"></i></a>
	...
	?>
        ...
        <!-- Mouseover dos erros do CONTACT FORM 7 -->
        ...
        <script>
			jQuery('.mk-nav-responsive-link').click(function(){
				var menu = jQuery('#mk-responsive-nav');
