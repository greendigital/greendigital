...
if ( $style == 'classic' ) {
    ...
    $output .= '<div class="mk-form-row"><i class="mk-li-user"></i><input placeholder="'.__( 'Nome:', 'mk_framework' ).'" type="text" required="required" name="contact_name" class="text-input" value="" tabindex="'.$tabindex_1.'" /></div>';
    if($phone == 'true') {
        $output .= '<div class="mk-form-row"><i class="mk-li-call"></i><input placeholder="'.__( 'Telefone:', 'mk_framework' ).'" type="text" name="contact_phone" class="text-input" value="" tabindex="'.$tabindex_2.'" /></div>';
    }
    $output .= '<div class="mk-form-row"><i class="mk-li-mail"></i><input placeholder="'.__( 'Email:', 'mk_framework' ).'" type="email" required="required" name="contact_email" class="text-input" value="" tabindex="'.$tabindex_3.'" /></div>';
    $output .= '<div class="mk-form-row"><i class="mk-li-pencil"></i><textarea required="required" placeholder="'.__( 'Mensagem:', 'mk_framework' ).'" name="contact_content" class="mk-textarea" tabindex="'.$tabindex_4.'"></textarea></div>';
    ...
    $output .= '<div class="mk-form-row" style="float:left;">
                    <button tabindex="'.$tabindex_5.'" class="mk-progress-button mk-button mk-skin-button flat-dimension contact-form-button medium" data-style="move-up">
                        <span class="mk-progress-button-content">'.__( 'ENVIAR', 'mk_framework' ).'</span>
    ...
    $output .= '<form class="mk-contact-form" method="post" novalidate="novalidate">';
    $output .= '<div class="mk-form-row"><input placeholder="'.__( 'Nome:', 'mk_framework' ).'" type="text" required="required" name="contact_name" class="text-input" value="" tabindex="'.$tabindex_1.'" /></div>';
    if($phone == 'true') {
        $output .= '<div class="mk-form-row"><input placeholder="'.__( 'Telefone:', 'mk_framework' ).'" type="text" required="required" name="contact_phone" class="text-input" value="" tabindex="'.$tabindex_2.'" /></div>';
    }
    $output .= '<div class="mk-form-row"><input placeholder="'.__( 'Email:', 'mk_framework' ).'" type="email" required="required" name="contact_email" class="text-input" value="" tabindex="'.$tabindex_3.'" /></div>';
    $output .= '<div class="mk-form-row"><textarea required="required" placeholder="'.__( 'Mensagem:', 'mk_framework' ).'" name="contact_content" class="mk-textarea" tabindex="'.$tabindex_4.'"></textarea></div>';
    ...
    $output .= '<form class="mk-contact-form" method="post" novalidate="novalidate">';
    $output .= '<div class="mk-form-row">';
    $output .= '<input placeholder="'.__( 'Nome:', 'mk_framework' ).'" type="text" required="required" name="contact_name" class="text-input '.(($phone == 'true')? 'two-third' : 'half').'" value="" tabindex="'.$tabindex_1.'" />';
    if($phone == 'true') {
        $output .= '<input placeholder="'.__( 'Telefone:', 'mk_framework' ).'" type="text" required="required" name="contact_phone" class="text-input two-third" value="" tabindex="'.$tabindex_2.'" />';
    }
    $output .= '<input placeholder="'.__( 'Email:', 'mk_framework' ).'" type="email" required="required" name="contact_email" class="text-input '.(($phone == 'true')? 'two-third' : 'half').'" value="" tabindex="'.$tabindex_3.'" />';
    $output .= '</div>';
    $output .= '<div class="mk-form-row"><textarea required="required" placeholder="'.__( 'Mensagem:', 'mk_framework' ).'" name="contact_content" class="mk-textarea" tabindex="'.$tabindex_4.'"></textarea></div>';
