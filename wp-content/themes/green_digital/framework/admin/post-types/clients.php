...
function edit_clients_columns($clients_columns) {
	$columns = array(
		...
		'title' => __('Nome do cliente', 'mk_framework'),
...
function register_clients_post_type(){
	...
	register_post_type('clients', array(
		'labels' => array(
			'name' => __('Clientes','mk_framework'), __('post type general name','mk_framework'),
			'singular_name' => __('Cliente','mk_framework'), __('post type singular name','mk_framework'),
			'add_new' => __('Adicionar novo cliente','mk_framework'), __('clients','mk_framework'),
			'add_new_item' => __('Adicionar novo cliente', 'mk_framework' ),
			'edit_item' => __('Editar Cliente','mk_framework'),
			'new_item' => __('Novo cliente','mk_framework'),
			'view_item' => __('Ver cliente','mk_framework'),
			'search_items' => __('Pesquisar clientes','mk_framework'),
			'not_found' =>  __('Nenhum cliente encontrado','mk_framework'),
			'not_found_in_trash' => __('Nenhum cliente encontrado na lixeira','mk_framework'),
			'parent_item_colon' => '',
